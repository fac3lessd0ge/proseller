...
const Forms = ({ initialValues }) => {
  const validationSchema = yup.object().shape({
    ...
    type: yup
      .string()
      .typeError('Choose type')
      .required('This is a required field')
      .not(['false'], 'Choose correct type'),
    email: yup
      .string()
  ...
  const [agreeWithPolicy, setAgreeWithPolicy] = React.useState(true);
    ...
    >
      ...
      >
        {({
          ...
          <div className={'form-field'}>
            ...
            <div className="form">
              <p>
                <label htmlFor="login">Device type</label>
                <br />
                <select
                  onChange={(e) => {
                    handleChange(e);
      ...
      <div style={{ fontSize: '12px', display: 'flex', alignItems: 'center' }}>
        <input
          ...
          style={{ aspectRatio: '1', width: '20px' }}
          checked={agreeWithPolicy}
        />
        <span style={{ marginLeft: '5px' }}>
          {' '}
          I have read and agreed with the{' '}
          <Link style={{ textDecoration: 'underline' }} to="/our-bot/offer">
            public offer
          </Link>{' '}
          and <br />{' '}
          <Link style={{ textDecoration: 'underline' }} to="/our-bot/privacy">
            confidentiality{' '}
          </Link>{' '}
          of the bot{' '}
        </span>
